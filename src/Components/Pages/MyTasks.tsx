...
const MyTasks = () => {
    ...
    const viewTask = async () => {
        try {
            return await axios.get(`https://challengetodo-z896.onrender.com/get-task`).then((res : any) => {
  ...
  return (
    <div>
        <div className="flex w-[calc(100vw-370px)] mt-[40px] h-[calc(100vh-35px)]  p-8 bg-red-100 ">

    ...
    <div>
      <div className="flex w-[calc(100vw-350px)] h-[calc(100vh)] p-6 flex-col bg-gray-200 pt-[100px] small:w-full">
        <div className="flex">
          ...
          <div className="text-[20px]">Tasks </div>
        </div>
        ...
        <div className="w-full h-[80px]  flex items-center justify-between shadow-md my-6 bg-white px-3">
          ...
          {...register("task")}/>
          <button className="w-[60px] h-[35px] rounded border flex justify-center items-center border-gray-500" type="submit">Create</button>
           </form>
        </div>
      </div>
    </div>
